...
TEST(pool_test, sanitize_positive)
{
    ...
    EXPECT_TRUE(!expected1.empty()) << "Empty output from non-empty input";
    ...
    EXPECT_TRUE(!expected2.empty()) << "Empty output from non-empty input";
    ...
    EXPECT_TRUE(!expected3.empty()) << "Empty output from non-empty input";
    ...
    EXPECT_TRUE(!expected4.empty()) << "Empty output from non-empty input";
