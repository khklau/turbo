...
TEST(concurrent_typed_slab_test, concurrent_typed_slab_copy_assignment_expand_length)
{
    tme::concurrent_typed_slab<uint_64_16_policy> slab1({ {sizeof(std::uint64_t), 2U}, {sizeof(std::uint16_t), 2U} });
    auto result1a = slab1.make_unique<std::uint64_t>(321U);
    EXPECT_EQ(tme::make_result::success, result1a.first) << "Make unique slab string failed";
...
TEST(concurrent_typed_slab_test, concurrent_typed_slab_copy_assignment_strink_length)
{
    tme::concurrent_typed_slab<uint_64_16_policy> slab1({ {sizeof(std::uint64_t), 2U}, {sizeof(std::uint16_t), 2U} });
    auto result1a = slab1.make_unique<std::uint64_t>(1991U);
    EXPECT_EQ(tme::make_result::success, result1a.first) << "Make unique slab string failed";
